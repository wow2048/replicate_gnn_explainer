...
from explain.config import ThresholdConfig, ThresholdType
...
class Explanation(Data, ExplanationMixin):
    ...
    The explanation object is a :obj:`~pyg_explainer.data.Data` object and
...
class HeteroExplanation(HeteroData, ExplanationMixin):
    ...
    The explanation object is a :obj:`~pyg_explainer.data.HeteroData` object
